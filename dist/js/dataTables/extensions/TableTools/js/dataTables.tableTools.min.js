 ...
 */
var TableTools;!function(a,b,c){var d=function(d,e){"use strict";
//include ZeroClipboard.js
/* ZeroClipboard 1.0.4
 * Author: Joseph Huckaby
 */
var f={version:"1.0.4-TableTools2",clients:{},// registered upload clients on page, indexed by id
moviePath:"",// URL to movie
nextId:1,// ID of next movie
$:function(a){
// simple DOM lookup utility function
// extend element with a few useful methods
return"string"==typeof a&&(a=b.getElementById(a)),a.addClass||(a.hide=function(){this.style.display="none"},a.show=function(){this.style.display=""},a.addClass=function(a){this.removeClass(a),this.className+=" "+a},a.removeClass=function(a){this.className=this.className.replace(new RegExp("\\s*"+a+"\\s*")," ").replace(/^\s+/,"").replace(/\s+$/,"")},a.hasClass=function(a){return!!this.className.match(new RegExp("\\s*"+a+"\\s*"))}),a},setMoviePath:function(a){
// set path to ZeroClipboard.swf
this.moviePath=a},dispatch:function(a,b,c){
// receive event from flash movie, send to client
var d=this.clients[a];d&&d.receiveEvent(b,c)},register:function(a,b){
// register new client to receive events
this.clients[a]=b},getDOMObjectPosition:function(a){
// get absolute coordinates for dom element
var b={left:0,top:0,width:a.width?a.width:a.offsetWidth,height:a.height?a.height:a.offsetHeight};for(""!==a.style.width&&(b.width=a.style.width.replace("px","")),""!==a.style.height&&(b.height=a.style.height.replace("px",""));a;)b.left+=a.offsetLeft,b.top+=a.offsetTop,a=a.offsetParent;return b},Client:function(a){
// constructor for new simple upload client
this.handlers={},
// unique ID
this.id=f.nextId++,this.movieId="ZeroClipboard_TableToolsMovie_"+this.id,
 ...
 */
return f.Client.prototype={id:0,// unique ID for us
...
sized:!1,glue:function(a,c){
// glue to DOM element
// elem can be ID or actual DOM element object
this.domElement=f.$(a);
// float just above object, or zIndex 99 if dom element isn't set
var d=99;this.domElement.style.zIndex&&(d=parseInt(this.domElement.style.zIndex,10)+1);
// find X/Y position of domElement
var e=f.getDOMObjectPosition(this.domElement);
// create floating DIV above element
this.div=b.createElement("div");var g=this.div.style;g.position="absolute",g.left="0px",g.top="0px",g.width=e.width+"px",g.height=e.height+"px",g.zIndex=d,"undefined"!=typeof c&&""!==c&&(this.div.title=c),0!==e.width&&0!==e.height&&(this.sized=!0),
// style.backgroundColor = '#f00'; // debug
this.domElement&&(this.domElement.appendChild(this.div),this.div.innerHTML=this.getHTML(e.width,e.height).replace(/&/g,"&amp;"))},positionElement:function(){var a=f.getDOMObjectPosition(this.domElement),b=this.div.style;if(b.position="absolute",
//style.left = (this.domElement.offsetLeft)+'px';
//style.top = this.domElement.offsetTop+'px';
b.width=a.width+"px",b.height=a.height+"px",0!==a.width&&0!==a.height){this.sized=!0;var c=this.div.childNodes[0];c.width=a.width,c.height=a.height}},getHTML:function(a,b){
// return HTML for movie
var c="",d="id="+this.id+"&width="+a+"&height="+b;if(navigator.userAgent.match(/MSIE/)){
// IE gets an OBJECT tag
var e=location.href.match(/^https/i)?"https://":"http://";c+='<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="'+e+'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10,0,0,0" width="'+a+'" height="'+b+'" id="'+this.movieId+'" align="middle"><param name="allowScriptAccess" value="always" /><param name="allowFullScreen" value="false" /><param name="movie" value="'+f.moviePath+'" /><param name="loop" value="false" /><param name="menu" value="false" /><param name="quality" value="best" /><param name="bgcolor" value="#ffffff" /><param name="flashvars" value="'+d+'"/><param name="wmode" value="transparent"/></object>'}else
// all other browsers get an EMBED tag
c+='<embed id="'+this.movieId+'" src="'+f.moviePath+'" loop="false" menu="false" quality="best" bgcolor="#ffffff" width="'+a+'" height="'+b+'" name="'+this.movieId+'" align="middle" allowScriptAccess="always" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" flashvars="'+d+'" wmode="transparent" />';return c},hide:function(){
// temporarily hide floater offscreen
this.div&&(this.div.style.left="-2000px")},show:function(){
// show ourselves after a call to hide()
this.reposition()},destroy:function(){
// destroy control and floater
if(this.domElement&&this.div){this.hide(),this.div.innerHTML="";var a=b.getElementsByTagName("body")[0];try{a.removeChild(this.div)}catch(c){}this.domElement=null,this.div=null}},reposition:function(a){if(
// reposition our floating div, optionally to new container
// warning: container CANNOT change size, only position
a&&(this.domElement=f.$(a),this.domElement||this.hide()),this.domElement&&this.div){var b=f.getDOMObjectPosition(this.domElement),c=this.div.style;c.left=""+b.left+"px",c.top=""+b.top+"px"}},clearText:function(){
// clear the text to be copy / saved
this.clipText="",this.ready&&this.movie.clearText()},appendText:function(a){
// append text to that which is to be copied / saved
this.clipText+=a,this.ready&&this.movie.appendText(a)},setText:function(a){
// set text to be copied to be copied / saved
this.clipText=a,this.ready&&this.movie.setText(a)},setCharSet:function(a){
// set the character set (UTF16LE or UTF8)
this.charSet=a,this.ready&&this.movie.setCharSet(a)},setBomInc:function(a){
// set if the BOM should be included or not
this.incBom=a,this.ready&&this.movie.setBomInc(a)},setFileName:function(a){
// set the file name
this.fileName=a,this.ready&&this.movie.setFileName(a)},setAction:function(a){
// set action (save or copy)
this.action=a,this.ready&&this.movie.setAction(a)},addEventListener:function(a,b){a=a.toString().toLowerCase().replace(/^on/,""),this.handlers[a]||(this.handlers[a]=[]),this.handlers[a].push(b)},setHandCursor:function(a){
// enable hand cursor (true), or default arrow cursor (false)
this.handCursorEnabled=a,this.ready&&this.movie.setHandCursor(a)},setCSSEffects:function(a){
// enable or disable CSS effects on DOM container
this.cssEffects=!!a},receiveEvent:function(c,d){var e;
// special behavior for certain events
switch(c=c.toString().toLowerCase().replace(/^on/,"")){case"load":if(
// movie claims it is ready, but in IE this isn't always the case...
// bug fix: Cannot extend EMBED DOM elements in Firefox, must use traditional function
this.movie=b.getElementById(this.movieId),!this.movie)return e=this,void setTimeout(function(){e.receiveEvent("load",null)},1);
...
if(this.handlers[c])for(var f=0,g=this.handlers[c].length;g>f;f++){var h=this.handlers[c][f];"function"==typeof h?
// actual function reference
h(this,d):"object"==typeof h&&2==h.length?
// PHP style object + method, i.e. [myObject, 'myMethod']
h[0][h[1]](this,d):"string"==typeof h&&
// name of function
a[h](this,d)}}},a.ZeroClipboard_TableTools=f,function(a,b,d){TableTools=function(b,c){/* Santiy check that we are a new instance */
