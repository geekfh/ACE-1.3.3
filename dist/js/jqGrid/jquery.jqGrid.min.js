...
// document node
a=a.documentElement);var c=this.removeWhite(a),d=this.toObj(c),e=this.toJson(d,a.nodeName,"	");return"{\n"+b+(b?e.replace(/\t/g,b):e.replace(/\t|\n/g,""))+"\n}"},
...
// Internal methods
toObj:function(a){var b={},c=/function/i;if(1===a.nodeType){
// element node ..
if(a.attributes.length){
// element with attributes ..
var d;for(d=0;d<a.attributes.length;d+=1)b["@"+a.attributes[d].nodeName]=(a.attributes[d].nodeValue||"").toString()}if(a.firstChild){
// element has child nodes ..
var e,f=0,g=0,h=!1;for(e=a.firstChild;e;e=e.nextSibling)1===e.nodeType?h=!0:3===e.nodeType&&e.nodeValue.match(/[^ \f\n\r\t\v]/)?
// non-whitespace text
f+=1:4===e.nodeType&&(
// cdata section node
g+=1);if(h)if(2>f&&2>g)for(
// structured element with evtl. a single text or/and cdata node ..
this.removeWhite(a),e=a.firstChild;e;e=e.nextSibling)3===e.nodeType?
// text node
b["#text"]=this.escape(e.nodeValue):4===e.nodeType?
// cdata node
c.test(e.nodeValue)?b[e.nodeName]=[b[e.nodeName],e.nodeValue]:b["#cdata"]=this.escape(e.nodeValue):b[e.nodeName]?b[e.nodeName]instanceof Array?b[e.nodeName][b[e.nodeName].length]=this.toObj(e):b[e.nodeName]=[b[e.nodeName],this.toObj(e)]:b[e.nodeName]=this.toObj(e);else
// mixed content
a.attributes.length?b["#text"]=this.escape(this.innerXml(a)):b=this.escape(this.innerXml(a));else if(f)
// pure text
a.attributes.length?b["#text"]=this.escape(this.innerXml(a)):(b=this.escape(this.innerXml(a)),"__EMPTY_ARRAY_"===b?b="[]":"__EMPTY_STRING_"===b&&(b=""));else if(g)
// cdata
if(g>1)b=this.escape(this.innerXml(a));else for(e=a.firstChild;e;e=e.nextSibling){if(c.test(a.firstChild.nodeValue)){b=a.firstChild.nodeValue;break}b["#cdata"]=this.escape(e.nodeValue)}}a.attributes.length||a.firstChild||(b=null)}else 9===a.nodeType?
// document.node
b=this.toObj(a.documentElement):alert("unhandled node type: "+a.nodeType);return b},toJson:function(a,b,c,d){void 0===d&&(d=!0);var e=b?'"'+b+'"':"",f="	",g="\n";if(d||(f="",g=""),"[]"===a)e+=b?":[]":"[]";else if(a instanceof Array){var h,i,j=[];for(i=0,h=a.length;h>i;i+=1)j[i]=this.toJson(a[i],"",c+f,d);e+=(b?":[":"[")+(j.length>1?g+c+f+j.join(","+g+c+f)+g+c:j.join(""))+"]"}else if(null===a)e+=(b&&":")+"null";else if("object"==typeof a){var k,l=[];for(k in a)a.hasOwnProperty(k)&&(l[l.length]=this.toJson(a[k],k,c+f,d));e+=(b?":{":"{")+(l.length>1?g+c+f+l.join(","+g+c+f)+g+c:l.join(""))+"}"}else e+="string"==typeof a?(b&&":")+'"'+a.replace(/\\/g,"\\\\").replace(/\"/g,'\\"')+'"':(b&&":")+a.toString();return e},innerXml:function(a){var b="";if("innerHTML"in a)b=a.innerHTML;else for(var c=function(a){var b,d="";if(1===a.nodeType){for(d+="<"+a.nodeName,b=0;b<a.attributes.length;b+=1)d+=" "+a.attributes[b].nodeName+'="'+(a.attributes[b].nodeValue||"").toString()+'"';if(a.firstChild){d+=">";for(var e=a.firstChild;e;e=e.nextSibling)d+=c(e);d+="</"+a.nodeName+">"}else d+="/>"}else 3===a.nodeType?d+=a.nodeValue:4===a.nodeType&&(d+="<![CDATA["+a.nodeValue+"]]>");return d},d=a.firstChild;d;d=d.nextSibling)b+=c(d);return b},escape:function(a){return a.replace(/[\\]/g,"\\\\").replace(/[\"]/g,'\\"').replace(/[\n]/g,"\\n").replace(/[\r]/g,"\\r")},removeWhite:function(a){a.normalize();var b;for(b=a.firstChild;b;)if(3===b.nodeType)
// text node
if(b.nodeValue.match(/[^ \f\n\r\t\v]/))b=b.nextSibling;else{
// pure whitespace text node
var c=b.nextSibling;a.removeChild(b),b=c}else 1===b.nodeType?(
// element node
this.removeWhite(b),b=b.nextSibling):
// any other node
...
return this.p.error=!1,this.p.errmsg="",a.isFunction(this.p.onChange)?this.p.onChange.call(this,this.p):!1},/*
		 ...
		 */
this.reDraw=function(){a("table.group:first",this).remove();var b=this.createTableForGroup(e.filter,null);a(this).append(b),a.isFunction(this.p.afterRedraw)&&this.p.afterRedraw.call(this,this.p)},/*
		 * Creates a grouping data for the filter
		 * @param group - object
		 * @param parentgroup - object
		 */
this.createTableForGroup=function(b,c){var d,f=this,g=a("<table class='group ui-widget ui-widget-content' style='border:0px none;'><tbody></tbody></table>"),
// create error message row
h="left";"rtl"===this.p.direction&&(h="right",g.attr("dir","rtl")),null===c&&g.append("<tr class='error' style='display:none;'><th colspan='5' class='ui-state-error' align='"+h+"'></th></tr>");var i=a("<tr></tr>");g.append(i);
// this header will hold the group operator type and group action buttons for
// creating subgroup "+ {}", creating rule "+" or deleting the group "-"
var j=a("<th colspan='5' align='"+h+"'></th>");if(i.append(j),this.p.ruleButtons===!0){
// dropdown for: choosing group operator type
var k=a("<select class='opsel'></select>");j.append(k);
// populate dropdown with all posible group operators: or, and
var l,m="";for(d=0;d<e.groupOps.length;d++)l=b.groupOp===f.p.groupOps[d].op?" selected='selected'":"",m+="<option value='"+f.p.groupOps[d].op+"'"+l+">"+f.p.groupOps[d].text+"</option>";k.append(m).bind("change",function(){b.groupOp=a(k).val(),f.onchange()})}
// button for adding a new subgroup
var n="<span></span>";if(this.p.groupButton&&(n=a("<input type='button' value='+ {}' title='Add subgroup' class='add-group'/>"),n.bind("click",function(){return void 0===b.groups&&(b.groups=[]),b.groups.push({groupOp:e.groupOps[0].op,rules:[],groups:[]}),f.reDraw(),f.onchange(),!1})),j.append(n),this.p.ruleButtons===!0){
// button for adding a new rule
var o,p=a("<input type='button' value='+' title='Add rule' class='add-rule ui-add'/>");p.bind("click",function(){for(
//if(!group) { group = {};}
void 0===b.rules&&(b.rules=[]),d=0;d<f.p.columns.length;d++){
// but show only serchable and serchhidden = true fields
var c=void 0===f.p.columns[d].search?!0:f.p.columns[d].search,e=f.p.columns[d].hidden===!0,g=f.p.columns[d].searchoptions.searchhidden===!0;if(g&&c||c&&!e){o=f.p.columns[d];break}}var h;// the html has changed, force reDraw
// for the moment no change have been made to the rule, so
// this will not trigger onchange event
// adding a new rule
return h=o.searchoptions.sopt?o.searchoptions.sopt:f.p.sopt?f.p.sopt:-1!==a.inArray(o.searchtype,f.p.strarr)?f.p.stropts:f.p.numopts,b.rules.push({field:o.name,op:h[0],data:""}),f.reDraw(),!1}),j.append(p)}
// button for delete the group
if(null!==c){// ignore the first group
var q=a("<input type='button' value='-' title='Delete group' class='delete-group'/>");j.append(q),q.bind("click",function(){
// remove group from parent
for(d=0;d<c.groups.length;d++)if(c.groups[d]===b){c.groups.splice(d,1);break}// signals that the filter has changed
// the html has changed, force reDraw
return f.reDraw(),f.onchange(),!1})}
// append subgroup rows
if(void 0!==b.groups)for(d=0;d<b.groups.length;d++){var r=a("<tr></tr>");g.append(r);var s=a("<td class='first'></td>");r.append(s);var t=a("<td colspan='4'></td>");t.append(this.createTableForGroup(b.groups[d],b)),r.append(t)}
// append rules rows
if(void 0===b.groupOp&&(b.groupOp=f.p.groupOps[0].op),void 0!==b.rules)for(d=0;d<b.rules.length;d++)g.append(this.createTableRowForRule(b.rules[d],b));return g},/*
...
var p=a("<td class='columns'></td>");n.append(p);
// dropdown for: choosing field
var q,r=a("<select></select>"),s=[];p.append(r),r.bind("change",function(){for(b.field=a(r).val(),i=a(this).parents("tr:first"),d=0;d<l.p.columns.length;d++)if(l.p.columns[d].name===b.field){j=l.p.columns[d];break}if(j){j.searchoptions.id=a.jgrid.randId(),f&&"text"===j.inputtype&&(j.searchoptions.size||(j.searchoptions.size=10));var c=a.jgrid.createEl.call(m,j.inputtype,j.searchoptions,"",!0,l.p.ajaxSelectOptions||{},!0);a(c).addClass("input-elm"),
//that.createElement(rule, "");
h=j.searchoptions.sopt?j.searchoptions.sopt:l.p.sopt?l.p.sopt:-1!==a.inArray(j.searchtype,l.p.strarr)?l.p.stropts:l.p.numopts;
// operators
var e="",g=0;for(s=[],a.each(l.p.ops,function(){s.push(this.oper)}),d=0;d<h.length;d++)q=a.inArray(h[d],s),-1!==q&&(0===g&&(b.op=l.p.ops[q].oper),e+="<option value='"+l.p.ops[q].oper+"'>"+l.p.ops[q].text+"</option>",g++);if(a(".selectopts",i).empty().append(e),a(".selectopts",i)[0].selectedIndex=0,a.jgrid.msie&&a.jgrid.msiever()<9){var k=parseInt(a("select.selectopts",i)[0].offsetWidth,10)+1;a(".selectopts",i).width(k),a(".selectopts",i).css("width","auto")}
// data
a(".data",i).empty().append(c),a.jgrid.bindEv.call(m,c,j.searchoptions),a(".input-elm",i).bind("change",function(c){var d=c.target;b.data="SPAN"===d.nodeName.toUpperCase()&&j.searchoptions&&a.isFunction(j.searchoptions.custom_value)?j.searchoptions.custom_value.call(m,a(d).children(".customelement:first"),"get"):d.value,l.onchange()}),setTimeout(function(){//IE, Opera, Chrome
b.data=a(c).val(),l.onchange()},0)}});
// populate drop down with user provided column definitions
var t=0;for(d=0;d<l.p.columns.length;d++){
// but show only serchable and serchhidden = true fields
var u=void 0===l.p.columns[d].search?!0:l.p.columns[d].search,v=l.p.columns[d].hidden===!0,w=l.p.columns[d].searchoptions.searchhidden===!0;(w&&u||u&&!v)&&(k="",b.field===l.p.columns[d].name&&(k=" selected='selected'",t=d),o+="<option value='"+l.p.columns[d].name+"'"+k+">"+l.p.columns[d].label+"</option>")}r.append(o);
// create operator container
var x=a("<td class='operators'></td>");n.append(x),j=e.columns[t],j.searchoptions.id=a.jgrid.randId(),f&&"text"===j.inputtype&&(j.searchoptions.size||(j.searchoptions.size=10));var y=a.jgrid.createEl.call(m,j.inputtype,j.searchoptions,b.data,!0,l.p.ajaxSelectOptions||{},!0);"nu"!==b.op&&"nn"!==b.op||(a(y).attr("readonly","true"),a(y).attr("disabled","true"));//retain the state of disabled text fields in case of null ops
// dropdown for: choosing operator
var z=a("<select class='selectopts'></select>");for(x.append(z),z.bind("change",function(){b.op=a(z).val(),i=a(this).parents("tr:first");var c=a(".input-elm",i)[0];"nu"===b.op||"nn"===b.op?(// disable for operator "is null" and "is not null"
b.data="","SELECT"!==c.tagName.toUpperCase()&&(c.value=""),c.setAttribute("readonly","true"),c.setAttribute("disabled","true")):("SELECT"===c.tagName.toUpperCase()&&(b.data=c.value),c.removeAttribute("readonly"),c.removeAttribute("disabled")),l.onchange()}),
// populate drop down with all available operators
h=j.searchoptions.sopt?j.searchoptions.sopt:l.p.sopt?l.p.sopt:-1!==a.inArray(j.searchtype,l.p.strarr)?l.p.stropts:l.p.numopts,o="",a.each(l.p.ops,function(){s.push(this.oper)}),d=0;d<h.length;d++)q=a.inArray(h[d],s),-1!==q&&(k=b.op===l.p.ops[q].oper?" selected='selected'":"",o+="<option value='"+l.p.ops[q].oper+"'"+k+">"+l.p.ops[q].text+"</option>");z.append(o);
// create data container
var A=a("<td class='data'></td>");n.append(A),
// textbox for: data
// is created previously
//ruleDataInput.setAttribute("type", "text");
A.append(y),a.jgrid.bindEv.call(m,y,j.searchoptions),a(y).addClass("input-elm").bind("change",function(){b.data="custom"===j.inputtype?j.searchoptions.custom_value.call(m,a(this).children(".customelement:first"),"get"):a(this).val(),l.onchange()});
// create action container
var B=a("<td></td>");
// create button for: delete rule
if(n.append(B),this.p.ruleButtons===!0){var C=a("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del'/>");B.append(C),
//$(ruleDeleteInput).html("").height(20).width(30).button({icons: {  primary: "ui-icon-minus", text:false}});
C.bind("click",function(){
// remove rule from group
for(d=0;d<c.rules.length;d++)if(c.rules[d]===b){c.rules.splice(d,1);break}// signals that the filter has changed
// the html has changed, force reDraw
return l.reDraw(),l.onchange(),!1})}return n},this.getStringForGroup=function(a){var b,c="(";if(void 0!==a.groups)for(b=0;b<a.groups.length;b++){c.length>1&&(c+=" "+a.groupOp+" ");try{c+=this.getStringForGroup(a.groups[b])}catch(d){alert(d)}}if(void 0!==a.rules)try{for(b=0;b<a.rules.length;b++)c.length>1&&(c+=" "+a.groupOp+" "),c+=this.getStringForRule(a.rules[b])}catch(e){alert(e)}return c+=")","()"===c?"":c},this.getStringForRule=function(b){var c,d,f,g,i="",j="",k=["int","integer","float","number","currency"];// jqGrid
for(c=0;c<this.p.ops.length;c++)if(this.p.ops[c].oper===b.op){i=this.p.operands.hasOwnProperty(b.op)?this.p.operands[b.op]:"",j=this.p.ops[c].oper;break}for(c=0;c<this.p.columns.length;c++)if(this.p.columns[c].name===b.field){d=this.p.columns[c];break}return void 0==d?"":(g=b.data,"bw"!==j&&"bn"!==j||(g+="%"),"ew"!==j&&"en"!==j||(g="%"+g),"cn"!==j&&"nc"!==j||(g="%"+g+"%"),"in"!==j&&"ni"!==j||(g=" ("+g+")"),e.errorcheck&&h(b.data,d),f=-1!==a.inArray(d.searchtype,k)||"nn"===j||"nu"===j?b.field+" "+i+" "+g:b.field+" "+i+' "'+g+'"')},this.resetFilter=function(){this.p.filter=a.extend(!0,{},this.p.initFilter),this.reDraw(),this.onchange()},this.hideError=function(){a("th.ui-state-error",this).html(""),a("tr.error",this).hide()},this.showError=function(){a("th.ui-state-error",this).html(this.p.errmsg),a("tr.error",this).show()},this.toUserFriendlyString=function(){return this.getStringForGroup(e.filter)},this.toString=function(){function a(a){if(c.p.errorcheck){var b,d;for(b=0;b<c.p.columns.length;b++)if(c.p.columns[b].name===a.field){d=c.p.columns[b];break}d&&h(a.data,d)}return a.op+"(item."+a.field+",'"+a.data+"')"}function b(c){var d,e="(";if(void 0!==c.groups)for(d=0;d<c.groups.length;d++)e.length>1&&(e+="OR"===c.groupOp?" || ":" && "),e+=b(c.groups[d]);if(void 0!==c.rules)for(d=0;d<c.rules.length;d++)e.length>1&&(e+="OR"===c.groupOp?" || ":" && "),e+=a(c.rules[d]);return e+=")","()"===e?"":e}
// this will obtain a string that can be used to match an item.
var c=this;return b(this.p.filter)},
// Here we init the filter
this.reDraw(),this.p.showQuery&&this.onchange(),
// mark is as created so that it will not be created twice on this element
this.filter=!0}}})},a.extend(a.fn.jqFilter,{/*
	 * Return SQL like string. Can be used directly
	 */
toSQLString:function(){var a="";return this.each(function(){a=this.toUserFriendlyString()}),a},/*
	 * Return filter data as object.
	 */
filterData:function(){var a;return this.each(function(){a=this.p.filter}),a},getParameter:function(a){return void 0!==a&&this.p.hasOwnProperty(a)?this.p[a]:this.p},resetFilter:function(){return this.each(function(){this.resetFilter()})},addFilter:function(b){"string"==typeof b&&(b=a.jgrid.parse(b)),this.each(function(){this.p.filter=b,this.reDraw(),this.onchange()})}})}(jQuery),/*jshint eqeqeq:false, eqnull:true, devel:true */
 ...
 * http://www.gnu.org/licenses/gpl-2.0.html
**/
"use strict";a.jgrid.inlineEdit=a.jgrid.inlineEdit||{},a.jgrid.extend({
//Editing
 ...
 * ajaxCellOptions
* */
"use strict";a.jgrid.extend({editCell:function(b,c,d){return this.each(function(){var e,f,g,h,i=this;if(i.grid&&i.p.cellEdit===!0){
...
for(f=0;f<b.length;f++)e.visibiltyOnNextGrouping[f]=a("#"+a.jgrid.jqID(d.p.id)+"_"+a.jgrid.jqID(b[f])).is(":visible");d.p.groupingView=a.extend(d.p.groupingView,c||{}),e.groupField=b,a(d).trigger("reloadGrid")})},groupingRemove:function(b){return this.each(function(){var c=this;if(void 0===b&&(b=!0),c.p.grouping=!1,b===!0){var d,e=c.p.groupingView;
// show previous hidden groups if they are hidden and weren't removed yet
for(d=0;d<e.groupField.length;d++)!e.groupColumnShow[d]&&e.visibiltyOnNextGrouping[d]&&a(c).jqGrid("showCol",e.groupField);a("tr.jqgroup, tr.jqfoot","#"+a.jgrid.jqID(c.p.id)+" tbody:first").remove(),a("tr.jqgrow:hidden","#"+a.jgrid.jqID(c.p.id)+" tbody:first").show()}else a(c).trigger("reloadGrid")})},groupingCalculations:{handler:function(a,b,c,d,e,f){var g={sum:function(){return parseFloat(b||0)+parseFloat(f[c]||0)},min:function(){return""===b?parseFloat(f[c]||0):Math.min(parseFloat(b),parseFloat(f[c]||0))},max:function(){return""===b?parseFloat(f[c]||0):Math.max(parseFloat(b),parseFloat(f[c]||0))},count:function(){return""===b&&(b=0),f.hasOwnProperty(c)?b+1:0},avg:function(){
// the same as sum, but at end we divide it
// so use sum instead of duplicating the code (?)
return g.sum()}};if(!g[a])throw"jqGrid Grouping No such method: "+a;var h=g[a]();if(null!=d)if("fixed"===e)h=h.toFixed(d);else{var i=Math.pow(10,d);h=Math.round(h*i)/i}return h}}})}(jQuery),/*jshint eqeqeq:false, eqnull:true, devel:true */
...
function b(a,b){var c,d,e,f=[];if(!this||"function"!=typeof a||a instanceof RegExp)throw new TypeError;for(e=this.length,c=0;e>c;c++)if(this.hasOwnProperty(c)&&(d=this[c],a.call(b,d,c,this))){f.push(d);
// We need break in order to cancel loop 
// in case the row is found
break}return f}a.assocArraySize=function(a){
// http://stackoverflow.com/a/6700/11236
var b,c=0;for(b in a)a.hasOwnProperty(b)&&c++;return c},a.jgrid.extend({pivotSetup:function(c,d){
// data should come in json format
// The function return the new colModel and the transformed data
// again with group setup options which then will be passed to the grid
var e=[],f=[],g=[],h=[],i={grouping:!0,groupingView:{groupField:[],groupSummary:[],groupSummaryPos:[]}},j=[],k=a.extend({rowTotals:!1,rowTotalsText:"Total",
// summary columns
colTotals:!1,groupSummary:!0,groupSummaryPos:"header",frozenStaticCols:!1},d||{});
...
/* 
			 ...
			 */
function d(a,c,d){var e;return e=b.call(a,c,d),e.length>0?e[0]:null}/*
			 * Check if the grouped row column exist (See find)
			 * If the row is not find in pivot rows retun null,
			 * otherviese the column
			 */
function l(a,b){var c,d=0,e=!0;for(c in a){if(a[c]!=this[d]){e=!1;break}if(d++,d>=this.length)break}return e&&(q=b),e}/*
			 * Perform calculations of the pivot values.
			 */
function m(a,b,c,d){var e;switch(a){case"sum":e=parseFloat(b||0)+parseFloat(d[c]||0);break;case"count":""!==b&&null!=b||(b=0),e=d.hasOwnProperty(c)?b+1:0;break;case"min":e=""===b||null==b?parseFloat(d[c]||0):Math.min(parseFloat(b),parseFloat(d[c]||0));break;case"max":e=""===b||null==b?parseFloat(d[c]||0):Math.max(parseFloat(b),parseFloat(d[c]||0))}return e}/*
			 * The function agragates the values of the pivot grid.
			 * Return the current row with pivot summary values
			 */
function n(b,c,d,e){
// default is sum
var f,g,i,j,k=c.length;for(j=a.isArray(d)?d.length:1,h=[],h.root=0,i=0;j>i;i++){var l,n=[];for(f=0;k>f;f++){if(null==d)g=a.trim(c[f].member)+"_"+c[f].aggregator,l=g;else{l=d[i].replace(/\s+/g,"");try{g=1===k?l:l+"_"+c[f].aggregator+"_"+f}catch(o){}}e[g]=n[g]=m(c[f].aggregator,e[g],c[f].member,b)}h[l]=n}return e}/*
			 * Recursive function which uses the tree to build the 
			 * columns from the pivot values and set the group Headers
			 */
function o(a){var b,c,d,f,g;for(d in a)// iterate
if(a.hasOwnProperty(d)){
// write amount of spaces according to level
// and write name and newline
if("object"!=typeof a[d]){
// If not a object build the header of the appropriate level
if("level"===d){if(void 0===K[a.level]&&(K[a.level]="",a.level>0&&"_r_Totals"!==a.text&&(j[a.level-1]={useColSpanStyle:!1,groupHeaders:[]})),K[a.level]!==a.text&&a.children.length&&"_r_Totals"!==a.text&&a.level>0){j[a.level-1].groupHeaders.push({titleText:a.text});var h=j[a.level-1].groupHeaders.length,i=1===h?M:L+(h-1)*u;j[a.level-1].groupHeaders[h-1].startColumnName=e[i].name,j[a.level-1].groupHeaders[h-1].numberOfColumns=e.length-i,L=e.length}K[a.level]=a.text}
// This is in case when the member contain more than one summary item
if(a.level===t&&"level"===d&&t>0)if(u>1){var l=1;for(b in a.fields)1===l&&j[t-1].groupHeaders.push({startColumnName:b,numberOfColumns:1,titleText:a.text}),l++;j[t-1].groupHeaders[j[t-1].groupHeaders.length-1].numberOfColumns=l-1}else j.splice(t-1,1)}
// Finally build the coulumns
if(
// if object, call recursively
null!=a[d]&&"object"==typeof a[d]&&o(a[d]),"level"===d&&a.level>0){c=0;for(b in a.fields){g={};for(f in k.aggregates[c])if(k.aggregates[c].hasOwnProperty(f))switch(f){case"member":case"label":case"aggregator":break;default:g[f]=k.aggregates[c][f]}u>1?(g.name=b,g.label=k.aggregates[c].label||b):(g.name=a.text,g.label="_r_Totals"===a.text?k.rowTotalsText:a.text),e.push(g),c++}}}}var p,q,r,s,t,u,v,w,x=c.length,y=0;
// Making the row totals without to add in yDimension
if(k.rowTotals&&k.yDimension.length>0){var z=k.yDimension[0].dataName;k.yDimension.splice(0,0,{dataName:z}),k.yDimension[0].converter=function(){return"_r_Totals"}}if(s=a.isArray(k.xDimension)?k.xDimension.length:0,t=k.yDimension.length,u=a.isArray(k.aggregates)?k.aggregates.length:0,0===s||0===u)throw"xDimension or aggregates optiona are not set!";var A;for(r=0;s>r;r++)A={name:k.xDimension[r].dataName,frozen:k.frozenStaticCols},A=a.extend(!0,A,k.xDimension[r]),e.push(A);
//tree = { text: 'root', leaf: false, children: [] };
//loop over alll the source data
for(var B=s-1,C={};x>y;){p=c[y];var D=[],E=[];v={},r=0;
// build the data from xDimension
do D[r]=a.trim(p[k.xDimension[r].dataName]),v[k.xDimension[r].dataName]=D[r],r++;while(s>r);var F=0;if(q=-1,w=d(f,l,D)){
// the pivot exists
if(q>=0){
// make the recalculations 
if(F=0,t>=1){for(F=0;t>F;F++)E[F]=a.trim(p[k.yDimension[F].dataName]),k.yDimension[F].converter&&a.isFunction(k.yDimension[F].converter)&&(E[F]=k.yDimension[F].converter.call(this,E[F],D,E));w=n(p,k.aggregates,E,w)}else 0===t&&(w=n(p,k.aggregates,null,w));
// update the row
f[q]=w}}else{
// if yDimension is set
if(F=0,t>=1){
// build the cols set in yDimension
for(F=0;t>F;F++)E[F]=a.trim(p[k.yDimension[F].dataName]),
// Check to see if we have user defined conditions
k.yDimension[F].converter&&a.isFunction(k.yDimension[F].converter)&&(E[F]=k.yDimension[F].converter.call(this,E[F],D,E));
// make the colums based on aggregates definition 
// and return the members for late calculation
v=n(p,k.aggregates,E,v)}else 0===t&&(
// if not set use direct the aggregates 
v=n(p,k.aggregates,null,v));
// add the result in pivot rows
f.push(v)}var G,H=0,I=null,J=null;
// Build a JSON tree from the member (see aggregateFunc) 
// to make later the columns 
// 
for(G in h){if(0===H)C.children&&void 0!==C.children||(C={text:G,level:0,children:[]}),I=C.children;else{for(J=null,r=0;r<I.length;r++)if(I[r].text===G){
//current[i].fields=member[kk];
J=I[r];break}J?I=J.children:(I.push({children:[],text:G,level:H,fields:h[G]}),I=I[I.length-1].children)}H++}y++}var K=[],L=e.length,M=L;t>0&&(j[t-1]={useColSpanStyle:!1,groupHeaders:[]}),o(C,0);var N;
