 ...
 */
!function(a,b,c,d){function e(c,d){this.w=a(b),this.el=a(c),this.options=a.extend({},j,d),this.init()}var f=("ontouchstart"in c.documentElement,function(){var a=c.createElement("div"),d=c.documentElement;if(!("pointerEvents"in a.style))return!1;a.style.pointerEvents="auto",a.style.pointerEvents="x",d.appendChild(a);var e=b.getComputedStyle&&"auto"===b.getComputedStyle(a,"").pointerEvents;return d.removeChild(a),!!e}()),g="mousedown touchstart MSPointerDown pointerdown",//ACE
h="mousemove touchmove MSPointerMove pointermove",//ACE
i="mouseup touchend touchcancel MSPointerUp MSPointerCancel pointerup pointercancel",j={listNodeName:"ol",itemNodeName:"li",rootClass:"dd",listClass:"dd-list",itemClass:"dd-item",dragClass:"dd-dragel",handleClass:"dd-handle",collapsedClass:"dd-collapsed",placeClass:"dd-placeholder",noDragClass:"dd-nodrag",emptyClass:"dd-empty",expandBtnHTML:'<button data-action="expand" type="button">Expand</button>',collapseBtnHTML:'<button data-action="collapse" type="button">Collapse</button>',group:0,maxDepth:5,threshold:20};e.prototype={init:function(){var b=this;b.reset(),b.el.data("nestable-group",this.options.group),b.placeEl=a('<div class="'+b.options.placeClass+'"/>'),a.each(this.el.find(b.options.itemNodeName),function(c,d){b.setParent(a(d))}),b.el.on("click","button",function(c){if(!(b.dragEl||"button"in c&&0!==c.button)){var d=a(c.currentTarget),e=d.data("action"),f=d.parent(b.options.itemNodeName);"collapse"===e&&b.collapseItem(f),"expand"===e&&b.expandItem(f)}});var c=function(c){c=c.originalEvent;//ACE
var d=a(c.target);if(!d.hasClass(b.options.handleClass)){if(d.closest("."+b.options.noDragClass).length)return;d=d.closest("."+b.options.handleClass)}
//ACE
!d.length||b.dragEl||"button"in c&&0!==c.button||"touches"in c&&1!==c.touches.length||(c.preventDefault(),b.dragStart("touches"in c?c.touches[0]:c))},d=function(a){b.dragEl&&(a=a.originalEvent,a.preventDefault(),b.dragMove("touches"in a?a.touches[0]:a))},e=function(a){b.dragEl&&(a=a.originalEvent,a.preventDefault(),b.dragStop("touches"in a?a.touches[0]:a))};
//ACE
/**if (hasTouch) {
...
if(p&&k.group!==o.data("nestable-group"))return;if(j=this.dragDepth-1+this.pointEl.parents(k.listNodeName).length,j>k.maxDepth)return;var q=d.pageY<this.pointEl.offset().top+this.pointEl.height()/2;g=this.placeEl.parent(),
// if empty create new list to replace empty placeholder
n?(e=a(c.createElement(k.listNodeName)).addClass(k.listClass),e.append(this.placeEl),this.pointEl.replaceWith(e)):q?this.pointEl.before(this.placeEl):this.pointEl.after(this.placeEl),g.children().length||this.unsetParent(g.parent()),this.dragRootEl.find(k.itemNodeName).length||this.dragRootEl.append('<div class="'+k.emptyClass+'"/>'),
// parent root list has changed
p&&(this.dragRootEl=o,this.hasNewRoot=this.el[0]!==this.dragRootEl[0])}}},a.fn.nestable=function(b){var c=this,d=this;return c.each(function(){var c=a(this).data("nestable");c?"string"==typeof b&&"function"==typeof c[b]&&(d=c[b]()):(a(this).data("nestable",new e(this,b)),a(this).data("nestable-id",(new Date).getTime()))}),d||c}}(window.jQuery||window.Zepto,window,document);